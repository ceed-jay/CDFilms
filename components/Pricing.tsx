          ...
          {packages.map((pkg) => (
            ...
            >
              <div className="relative h-40 overflow-hidden">
                ...
                {pkg.isPopular && <div className="absolute top-3 right-3 bg-gold text-white text-[8px] font-bold tracking-[0.15em] uppercase px-3 py-1.5 rounded-full shadow-md">Popular</div>}
              ...
              <div className="p-6 flex flex-col flex-grow">
                <p className="text-gray-500 text-xs leading-relaxed mb-6 italic">"{pkg.description}"</p>
                ...
                <button
                  ...
                  className={`w-full py-3.5 text-center text-[10px] font-bold tracking-[0.15em] uppercase transition-all outline-none border ${
                    pkg.isPopular ? 'bg-gold border-gold text-white hover:bg-transparent hover:text-gold' : 'bg-black border-black text-white hover:bg-transparent hover:text-black'
                  }`}
                >Inquire Now</button>
              </div>
            </div>
